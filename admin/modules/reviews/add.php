...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = insert('reviews', $dataInsert);
    if ($result) {
            ...
            <div class="container">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="user_id" name="user_id" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="rating">Rating</label>
                        <textarea class="form-control" id="rating" name="rating" required></textarea>
                    </div>
                    <div class="form-group">
