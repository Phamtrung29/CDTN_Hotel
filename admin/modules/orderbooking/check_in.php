...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (isset($_POST['confirmation_code'])) {
        ...
        $orderQuery = "SELECT confirmation_code FROM orderbooking WHERE confirmation_code = '$confirmation_code'";
        $order = oneRaw($orderQuery, "confirmation_code = '$confirmation_code'");
        ...
        if ($order && $order['confirmation_code'] === $confirmation_code) {
            ...
            update('orderbooking', $dataUpdate, "confirmation_code = '$confirmation_code'");
