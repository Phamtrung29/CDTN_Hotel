...
if(isPost()){
    ...
    if(empty($error)){
        ...
        if($updateStatus){
            setFlashData('smg', 'Sửa user thành công!');
            setFlashData('smg_type', 'success'); 
        }else{
            setFlashData('smg', 'Sửa user không thành công!');
        ...
        require_once('templaces/layout/navbar.php');?>
            <div class="row">
                <div class="col-4 mg-home" style="margin: 50px auto;">
                    <h2 class="text-center text-uppercase">Sửa thông tin user</h2>
                    <?php
            if(!empty($smg)){
                getSmg($smg, $smg_type);
            } 
                ...
                ?>
                        ...
                        <div class=" form-group">
                            ...
                            <input name="password" type="password" class="form-control"
                                placeholder="Password(Không nhập nếu không thay đổi!)">
                            <?php 
